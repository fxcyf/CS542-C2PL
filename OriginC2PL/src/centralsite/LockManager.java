...
public class LockManager {
	...
	public Pair<Integer, ArrayList<Integer>> checkDeadlocks() {
		...
		if (edgesToRemove != null) {
			...
			System.out.println("Going to abort transaction: " + abortingTransaction.intValue());
	...
	public void printLockTable() {
		...
		System.out.println("current lock table");
		/* Print something if the lock table is empty */
		if (lockTable.isEmpty()) {
			System.out.println("[]");
			return;
		}
		System.out.println("[lock item, lock type, tid, site id]");
	...
	public void printQueueTable() {
		...
		System.out.println("[operation, tid, site id]");
	...
	public ArrayList<Integer> releaseLocks(Transaction transaction) throws Exception {
		...
		System.out.println("Transaction " + transaction.getId() + " releases all the locks");

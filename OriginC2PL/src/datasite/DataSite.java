...
public class DataSite implements Runnable, DataSiteInterface {
	...
	public static void main(String[] args) {
		...
		print(TAG, "Distributed site ready");
	...
	public static void print(String tag, String message) {
		...
		if (verbose) {
			System.out.println(DataSite.getTimestamp() + ": " + message);
		}
	}
	...
	public DataSite(String host, int port, String transactionsFile) {
		...
		try {
			...
			print(TAG, "Dist site stub: " + siteStubName);

			/* Indicate the data site is ready */
			System.out.println(DataSite.getTimestamp() + " " + "Dist site " + id + " is ready");
	...
	public void abort() throws RemoteException {
		...
		abort = true;
		print(TAG, "Site " + id + " abort current transaction");
		...
		while (true) {
			...
			try {
				...
				synchronized (this) {
					...
					print(TAG, "Begin new transaction");

					/*  */
					if (transaction == null) {

						print(TAG, "Site " + id + " no more transaction");
						...
						print(TAG, "Starting transaction " + transaction.getId());
	...
	public void write() throws RemoteException {
		// System.out.println(DataSite.getTimestamp() + " " + TAG + " Writing the info
		// for site " + id);
	}
